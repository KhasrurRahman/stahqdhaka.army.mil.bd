            ...
            <form id="reject_file_sms_form">
             <fieldset class="xfieldset">
              ...
              <div class="col-xs-5">
                ...
                <div>
                  <input type="checkbox" class="attach_file" id="road_permit" name="road_permit"
                         value="রোড পারমিট এর মেয়াদ উর্ত্তীন" />
                  <label for="road_permit">Road Permit </label>
                </div>
                <div>
                  <input type="checkbox" class="attach_file" id="police_verification" name="police_verification"
                         value="পুলিশ ভেরিফিকেশন" />
          ...
          <div class="col-md-10">
            <form id="reject_sms_form">
              ...
              <div class="col-md-7">
               ...
               class="form-control in-form sms_template" style="width: 100%;" >
