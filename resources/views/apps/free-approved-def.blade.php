...
@section('content')
    <div class="content-area" style="padding-top: 15px;">
        <div class="container-fluid pl-0 pr-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('freeApprovedApp', $def) }}" method="GET">
                        <table>
                            <tr>
                                <td>
            ...
            <div class="panel-heading">
                <h3 class="pptitle">Free Approved Applications</h3>
            </div>
    ...
    <script>
        ...
        $(function() {
            $('#table').DataTable({
                ...
                iDisplayLength: 10,
                ajax: {
                    url: '{{ route('all_free_approved.datatable') }}',
                    data: function (d) {
                        d.def = '{{ $def }}';
                        d.reg_no = '{{ $reg_no }}';
                        d.ba = '{{ $ba }}';
                ...
                columns: [
                    ...
                    {data: 'free_comment', name: 'free_comment'},
                ],
                order:[[0,"desc"]]
            });
