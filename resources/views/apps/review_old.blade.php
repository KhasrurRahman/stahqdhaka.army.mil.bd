    ...
    <div class="modal fade" id="nid4-copy" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" style="padding:0;">
            <img src="{{url('/')}}{{$app->applicant->applicantDetail->applicant_photo}}" class="img-fluid" alt="">
          </div>
        </div>
      </div>
    </div>
             ...
             <fieldset class="xfieldset">
              <div class="row justify-content-center">
                ...
                <div>
                  ...
                  value="Authorised Certificate Copy" />
                ...
                <div>
                  ...
                  value="Marriage_Certificate_Copy"/>
              ...
              <div class="col-md-5">
                ...
                <div>
                  ...
                  value="Ward Commissioner Certificate Copy" />
                ...
                <div>
                  ...
                  value="House Owner/CEO Certificate Copy" />
...
<div class="modal fade" id="myIssueModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog modal-lg">
   ...
   <form id="issueSticker_Form">
    ...
    <div class="col-md-7">
      <input type="text" value="{{!empty($app->stickerCategory->price)?$app->stickerCategory->price:''}}" name="amount" id="amount"  class="form-control in-form" placeholder="" required readonly style=" cursor:no-drop;">
    </div>
    <div class="col-md-4 offset-md-1">
...
<div class="col-md-7" >
  <input type="number" value="{{!empty($app->stickerCategory->price)?$app->stickerCategory->price:''}}" name="total_amount"  class="form-control in-form" id="total_amount" placeholder="" required readonly style=" cursor:no-drop;">
</div>
<div class="col-md-4 offset-md-1 special_case" hidden>
