...
@section('content')
    <div class="content-area" style="padding-top: 15px;">
        <div class="container-fluid  pl-0 pr-0">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('deliveredApp', $def) }}" method="GET">
                        <table>
                            <tr>
                                <td>
            ...
            <div class="panel-heading">
                <h3 class="pptitle">Delivered Stickers</h3>
            </div>
             <div class="panel-body" style="padding:10px 0;" >
                <div id="example-wrapper" class="table-responsive">
    ...
    <script>
        ...
        $(function() {
            $('#table').DataTable({
                ...
                iDisplayLength: 10,
                ajax: {
                    url: '{{ route('all_delevered.datatable') }}',
                    data: function (d) {
                        d.def = '{{ $def }}';
                ...
                columns: [
                    ...
                    {data: 'vehicleSticker_sticker_number', name: 'vehicleSticker.sticker_number'},
