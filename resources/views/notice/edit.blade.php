        ...
        <div class="container-fluid  pl-0 pr-0" >
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <h3 class="pptitle"> Notice Edit </h3>
                </div>
                ...
                <div class="panel-body" style="padding:10px 0;">
                    <div id="example-wrapper">
                        <form action="{{ route('website_notice.edit',['notice'=>$notice->id]) }}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="title" placeholder="Title" id="title" class="form-control in-form" value="{{ $notice->title }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="sort" placeholder="Enter Sort" id="sort" class="form-control in-form" value="{{ $notice->sort }}" required>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <br>
                                        <textarea name="description" id="description" class="form-control" rows="10"> {{ $notice->description }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <select name="link_active" id="link_active" class="form-control select2 in-form">
                                            <option {{ $notice->link_active == 1 ? 'selected' : ''  }} value="1">Enable</option>
                                            <option {{ $notice->link_active == 0 ? 'selected' : ''  }} value="0">Disable</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <select name="status" id="status" class="form-control select2 in-form">
                                            <option {{ $notice->status == 1 ? 'selected' : ''  }} value="1">Enable</option>
                                            <option {{ $notice->status == 0 ? 'selected' : ''  }} value="0">Disable</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="file-container" id="file-container">
                                            ...
                                            <div class="file-item row mt-4">
                                                <div class="col-md-3">
                                                    <label for="" class="label-form"> PDF <span class="text-danger">*</span></label><a role="button" class="btn btn-danger btn-sm btn-remove">X</a> <br>
                                                    <small></small>
                                                </div>
                                                <div class="col-md-9">
                                                    <input type="hidden" name="pdf_id[]" value="{{ $file->id }}">
                                                    <input type="file" disabled name="pdf[]">
                                                    @if ($file->pdf)
                                                        <a target="_blank" href="{{ asset($file->pdf) }}">Pdf</a>
                                                    @endif
                                                </div>
                                            </div>
                                            @endforeach
