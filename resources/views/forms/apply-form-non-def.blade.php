                                ...
                                <div class="form-personal_info">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <button type="button" name="" class="btn btn-info change-btn" data-photo="{{!empty(auth()->guard('applicant')->user()->applicantDetail->applicant_photo)?url(auth()->guard('applicant')->user()->applicantDetail->applicant_photo):url($runningApp->applicant->applicantDetail->applicant_photo)}}">
                                                Change
                                            </button>
                                 ...
                                 <span style="display: inline-block; margin-bottom: 0px; margin-top: 30px;" title="Use office address as present address">Same as office address</span> -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            @endif
                                            <label for="app_address_same_as_present" style="display: inline-block; margin-bottom: 0px; margin-top: 30px; cursor: pointer;" title="Use present address as permanent address">Same as present address</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3 offset-md-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 mt-2 ">
                                            <select name="residence_type" id="residence_type" class="form-control in-form mandatory" required>
                                                <option selected value="{{!empty(auth()->guard('applicant')->user()->applicantDetail->residence_type)?auth()->guard('applicant')->user()->applicantDetail->residence_type:''}}">{{!empty(auth()->guard('applicant')->user()->applicantDetail->residence_type)?auth()->guard('applicant')->user()->applicantDetail->residence_type:'--Select One--'}}</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <button type="button" name="" class="btn btn-info change-btn" data-photo="{{!empty($runningApp->applicant->applicantDetail->nid_photo)?url($runningApp->applicant->applicantDetail->nid_photo):url(auth()->guard('applicant')->user()->applicantDetail->nid_photo)}}">
                                                Change
                                            </button>
                                            <button type='button' class='btn btn-warning cancel-btn' hidden="">Cancel</button>
                            ...
                            <div class="vehicle-details-container">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="vehicle_type" id="vehicle_type" class="form-control-sm mandatory" required>
                                            <option selected value="{{$allocated_sticker->application->vehicleType->id}}">{{$allocated_sticker->application->vehicleType->name}}</option>
                                        </select>
                                    ...
                                    @if(!empty($allocated_sticker))
                                    <div class="col-md-8">
                                        <input type="text" name="vehicle_reg_no" id="vehicle_reg_no" class="form-control in-form mandatory" value="{{$allocated_sticker->reg_number}}" required>
                                    </div>
                                    @else
                                    <div class="col-md-8">
                                        <input type="text" name="vehicle_reg_no" id="vehicle_reg_no" class="form-control in-form mandatory" placeholder="Enter your vehicle registration number" required value="{{!empty($runningApp->vehicleinfo->reg_number)?$runningApp->vehicleinfo->reg_number:''}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <button type="button" name="" class="btn btn-info change-btn" data-photo="{{url('')}}{{$allocated_sticker->application->vehicleinfo->reg_cert_photo}}">
                                            Change
                                        </button>
                                        <button type='button' class='btn btn-warning cancel-btn' hidden="">Cancel</button>
                                        ...
                                        <input type="file" id="image2_b_exist" accept="image/png, image/jpg, image/jpeg" class="form-control in-form mandatory" name="vehicle_reg_photo" required disabled="">
                                        <button type="button" name="" class="btn btn-info change-btn" data-photo="{{url('')}}{{$runningApp->vehicleinfo->reg_cert_photo}}">
                                            Change
                                        </button>
                                ...
                                <div class="row">
                                    <div class="col-md-3 offset-md-1">
                                        <label for="" class="label-form">Owners name</label><span>*</span><br>
                                        <small></small>
                                    </div>
                                    @if(!empty($allocated_sticker))
                                    <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-3 offset-md-1">
                                        <label for="" class="label-form">If the owner is a company</label> <span></span> <br>
                                        <small></small>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 company_info_field" hidden>
                                        ...
                                        <div id="err_msg_companyflat" class="err_msg" hidden><i class="fas fa-exclamation-triangle"></i> <span id="err_companyflat"> </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <button type="button" name="" class="btn btn-info change-btn" data-photo="{{!empty($allocated_sticker->application->vehicleinfo->tax_token_photo)?url($allocated_sticker->application->vehicleinfo->tax_token_photo):url($runningApp->vehicleinfo->tax_token_photo)}}">
                                            Change
                                        </button>
                                        <button type='button' class='btn btn-warning cancel-btn' hidden="">Cancel</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <button type="button" name="" class="btn btn-info change-btn" data-photo="{{!empty($allocated_sticker->application->vehicleinfo->fitness_cert_photo)?url($allocated_sticker->application->vehicleinfo->fitness_cert_photo):url($runningApp->vehicleinfo->fitness_cert_photo)}}">
                                            Change
                                        </button>
                                        <button type='button' class='btn btn-warning cancel-btn' hidden="">Cancel</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <button type="button" name="" class="btn btn-info change-btn" data-photo="{{!empty($allocated_sticker->application->vehicleinfo->insurance_cert_photo)?url($allocated_sticker->application->vehicleinfo->insurance_cert_photo):url($runningApp->vehicleinfo->insurance_cert_photo)}}">
                                            Change
                                        </button>
                                        <button type='button' class='btn btn-warning cancel-btn' hidden="">Cancel</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 is_transparent_hide">
                                        <select name="glass_type" id="glass_type" class="form-control in-form mandatory">
                                            ...
                                            <option selected value="{{!empty($allocated_sticker->application->vehicleinfo->glass_type)?$allocated_sticker->application->vehicleinfo->glass_type:''}}">{{!empty($allocated_sticker->application->vehicleinfo->glass_type)?$allocated_sticker->application->vehicleinfo->glass_type:''}}</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 is_transparent_hide">
                                        <select name="glass_type" id="glass_type" class="form-control in-form mandatory">
                                            ...
                                            <option selected value="{{$runningApp->vehicleinfo->glass_type}}">{{$runningApp->vehicleinfo->glass_type}}</option>
                            ...
                            <div class="driver-details-container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 not_self_driven" hidden>
                                        ...
                                        <button type="button" name="" class="btn btn-info change-btn" data-photo="{{!empty($allocated_sticker->application->driverinfo->photo)?url($allocated_sticker->application->driverinfo->photo):url($runningApp->driverinfo->photo)}}">
                                            Change
                                        </button>
                                        <button type='button' class='btn btn-warning cancel-btn' hidden="">Cancel</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 not_self_driven" hidden>
                                        ...
                                        <label for="driver_address_same_as_present" style="display: inline-block; margin-bottom: 0px;cursor: pointer; margin-top: 30px;" title="Use present address">Same as present address</label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 not_self_driven" hidden>
                                        ...
                                        <button type="button" name="" class="btn btn-info change-btn" data-photo="{{!empty($allocated_sticker->application->driverinfo->nid_photo)?url($allocated_sticker->application->driverinfo->nid_photo):url($runningApp->driverinfo->nid_photo)}}">
                                            Change
                                        </button>
                                        <button type='button' class='btn btn-warning cancel-btn' hidden="">Cancel</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <button type="button" name="" class="btn btn-info change-btn" data-photo="{{!empty($allocated_sticker->application->driverinfo->licence_photo)?url($allocated_sticker->application->driverinfo->licence_photo):url($runningApp->driverinfo->licence_photo)}}">
                                            Change
                                        </button>
                                        <button type='button' class='btn btn-warning cancel-btn' hidden="">Cancel</button>
                            ...
                            <div class="doc-details-container">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 ">
                                        ...
                                        <input type="file" accept="image/png, image/jpg, image/jpeg" id="image11_b_school" name="school_cert_photo" class="form-control mandatory in-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 ">
                                        ...
                                        <input type="file" accept="image/png, image/jpg, image/jpeg" id="image11_b_civil_service" name="civil_service_photo" class="form-control mandatory in-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 ">
                                        ...
                                        <input type="file" accept="image/png, image/jpg, image/jpeg" id="image11_b_job" name="job_cert_photo" class="form-control mandatory in-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 ">
                                        ...
                                        <input type="file" accept="image/png, image/jpg, image/jpeg" id="image11_b_house_owner_ceo_cert_photo" name="house_owner_cert" class="form-control mandatory in-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 ">
                                        ...
                                        <input type="file" accept="image/png, image/jpg, image/jpeg" id="image11_b_wardCom" name="ward_com_cert" class="form-control mandatory in-form">
