                        ...
                        <form action="{{ route('slider.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="name" id="name" class="form-control in-form" value="{{ old('name', $slider->name) }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="position" id="position" class="form-control in-form" value="{{ old('position', $slider->position) }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="slider_image">
                                            <img id="image_show" src="{{ $slider->image? asset('assets/images/sliders/'.$slider->image): asset('assets/images/no_image.png') }}" alt="Slider Image">
                                        </div>
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select name="status" id="status" class="form-control in-form">
                                            <option @if ($slider->status==1) selected @endif value="1">Enable</option>
