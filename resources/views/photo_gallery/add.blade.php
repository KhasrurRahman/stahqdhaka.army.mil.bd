        ...
        <div class="container-fluid  pl-0 pr-0" >
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <b class=""> Add New Photo </b> 
                    <a href="{{ route('photo_gallery.list') }}" class="btn btn-primary btn-sm" style="float:right"> Photo List</a>
                </div>
                @if(session('success'))
                    ...
                    <div id="example-wrapper">
                        <form action="{{ route('photo_gallery.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="" class="label-form"> Photo Gallery Name <span class="text-danger">*</span> </label> <br>
                                        <small></small>
                                    </div>
                                    <div class="col-md-9">
                                    ...
                                    <div class="col-md-3">
                                        <label for="" class="label-form"> Position <span class="text-danger">*</span> </label> <br>
                                        <small></small>
                                    </div>
                                    <div class="col-md-9">
                                    ...
                                    <div class="col-md-3">
                                        <label for="" class="label-form"> Image <span class="text-danger">*</span></label> <br>
                                        <small></small>
                                    </div>
                                    <div class="col-md-9">
                                        <br>
