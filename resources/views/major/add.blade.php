                        ...
                        <form action="{{ route('major.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="rank" id="rank" class="form-control in-form" value="{{ old('rank') }}" required>
                                    </div>
                                    {{-- --new add-- --}}
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="ba" id="ba" class="form-control in-form" value="{{ old('ba') }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="sso" id="sso" class="form-control in-form" value="{{ old('sso') }}" required>
                                    </div>
                                   {{-- --new add-- --}}
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="mobile" id="mobile" class="form-control in-form" value="{{ old('mobile') }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="telephone" id="telephone" class="form-control in-form" value="{{ old('telephone') }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <br>
                                        <textarea name="responsibility" id="responsibility" class="form-control" rows="10"> {!! old('responsibility') !!} </textarea>
                                    </div>
