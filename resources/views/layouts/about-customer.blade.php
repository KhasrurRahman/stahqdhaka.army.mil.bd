        ...
        <div class="content-area" style="padding-top: 15px;">
            <div class="container-fluid  pl-0 pr-0">
                ...
                <div class="row justify-content-center mt-3">
                    <div class="col-6"><a class="btn btn-lg btn-success btn-block" href="{{url('/customer/home')}}">Apply for Sticker</a></div>
                    <div class="col-6"><a class="btn btn-lg btn-success btn-block" href="{{url('/applied-applications')}}">Applied Sticker</a> </div>
                </div>
