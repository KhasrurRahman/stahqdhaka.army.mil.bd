            ...
            <div class=" content">
                ...
                <div class="col-12 col-sm-12 col-md-5  col-lg-5 contain-r">
                    <div class="m-5 info-r">
                        ...
                        <div>
                            <a href="{{ route('footer.terms_condition') }}" style="color: #96DEA2; border-right:1px solid #fff;">
                                Terms & Condition
                            </a>&nbsp;&nbsp;
                            <a href="{{ route('footer.privacy_policy') }}" style="color: #96DEA2; border-right:1px solid #fff;">
                                Privacy Policy
                            </a>&nbsp;&nbsp;
                            <a href="{{ route('footer.return_refund') }}" style="color: #96DEA2">
